...
class OkHttpTask implements Callback, ProgressCallback{
    ...
    /**在此方法中调用okhttp3.Call#enqueue(okhttp3.Callback)方法进行起步请求*/
    protected void run() throws Exception{
        ...
        OkHttpCallManager.getInstance().addCall(url, call);/*将Call对象加入到OkHttpCallManager管理类*/
        //执行请求
        call.enqueue(this);
    }
    ...
    /**从服务端获取到响应Response后封装成ResponData进行后续处理,该方法运行在UI主线程*/
