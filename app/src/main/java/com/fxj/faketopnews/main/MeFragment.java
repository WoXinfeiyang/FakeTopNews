...
public class MeFragment extends BaseFragment {
    ...
    private final String tag=MeFragment.class.getSimpleName()+"_fxj";
    ...
    public void onAttach(Context context) {
        ...
        KLog.i(tag,"MeFragment.onAttach");
        mContext = context;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        KLog.i(tag,"MeFragment.onCreate");
    }
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState) {
        ...
        KLog.i(tag,"MeFragment.onCreateView");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        KLog.i(tag,"MeFragment.onViewCreated");
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        KLog.i(tag,"MeFragment.onActivityCreated");
    }

    @Override
    public void onStart() {
        super.onStart();
        KLog.i(tag,"com.fxj.faketopnews.main.MeFragment.onStart");
    }

    @Override
    public void onResume() {
        super.onResume();
        KLog.i(tag,"MeFragment.onResume");
    }

    @Override
    public void onPause() {
        super.onPause();
        KLog.i(tag,"MeFragment.onPause");
    }

    @Override
    public void onStop() {
        super.onStop();
        KLog.i(tag,"MeFragment.onStop");
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        KLog.i(tag,"MeFragment.onDestroyView");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        KLog.i(tag,"MeFragment.onDestroy");
    }

    @Override
    public void onDetach() {
        super.onDetach();
        KLog.i(tag,"MeFragment.onDetach");
    }
}
